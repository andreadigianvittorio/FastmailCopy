    ...
    public partial class FC_Main : Form
    {
        ...
        {   
            ...
            while (year <= DateTime.Now.Year)
            {
                ...
                {
                    string Vsource = @"\\nas3\Fastmail\Fastmail\verbali\" + year + @"\" + txt_fmcode.Text;
            ...
            while (year <= DateTime.Now.Year)
            {
                ...
                {
                    string Rsource = @"\\nas3\Fastmail\Fastmail\images\" + year + @"\" + txt_fmcode.Text;
            ...
            while (year <= DateTime.Now.Year)
            {
                ...
                {
                    string Rsource = @"\\nas3\Fastmail\Fastmail\Cad\" + year + @"\" + txt_fmcode.Text;
            ...
            while (year <= DateTime.Now.Year)
            {
                ...
                {
                    string Rsource = @"\\nas3\Fastmail\Fastmail\Buste\" + year + @"\" + txt_fmcode.Text;
            ...
            while (year <= DateTime.Now.Year)
            {
                ...
                {
                    string Rsource = @"\\nas3\Fastmail\Fastmail\Pec\" + year + @"\" + txt_fmcode.Text;
